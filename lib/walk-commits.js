...
const get_affected_files_1 = __importDefault(require("./get-affected-files"));
const get_affected_pkgs_1 = __importDefault(require("./get-affected-pkgs"));
    ...
    return __asyncGenerator(this, arguments, function* walkCommits_1() {
        ...
        while (true) {
            try {
                ...
                const affectedFiles = yield __await(get_affected_files_1.default(hash));
                const affectedPackages = yield __await(get_affected_pkgs_1.default(affectedFiles));
                yield yield __await({ hash, commit, affectedFiles, affectedPackages });
                cursor = `${hash}^1`;
            }
            catch (error) {
...
//# sourceMappingURL=walk-commits.js.map